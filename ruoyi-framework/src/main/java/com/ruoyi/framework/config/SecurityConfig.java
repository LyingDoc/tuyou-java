...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                // 微信登录白名单地址
                .antMatchers("/system/weixin/*").anonymous()
                // 对于登录login 注册register 验证码captchaImage 允许匿名访问
                .antMatchers("/auth/login", "/auth/register", "/code","/WebSocket/**/**").anonymous()
                // 静态资源，可匿名访问
                .antMatchers(HttpMethod.GET, "/", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/profile/**","/flow/oa/formfile/file/**").permitAll()
