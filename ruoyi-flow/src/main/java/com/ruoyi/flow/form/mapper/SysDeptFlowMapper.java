 ...
 * @author ruoyi
 */
public interface SysDeptFlowMapper extends BaseMapper<SysDeptEntity>
{
    /**
     * 查询部门管理数据
     * 
     ...
     * @return 结果
     */
    public SysDeptEntity checkDeptNameUnique(@Param("deptName") String deptName, @Param("parentId") Long parentId);
    ...
    List<Long> getChildDeptId(@Param("ancestors") String  ancestors);
}
