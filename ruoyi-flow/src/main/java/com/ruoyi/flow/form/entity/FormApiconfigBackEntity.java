...
@Data
@ApiModel("api接口备份表信息")
@TableName("form_apiconfig_back")
public class FormApiconfigBackEntity extends Model<FormApiconfigBackEntity> {
    private static final long serialVersionUID = 1L;
    /**
     * 主键
     */
@ApiModelProperty("主键")
    @TableId(value = "form_apiconfig_back_id")
    private String formApiconfigBackId;
    /**
     * 创建日期
     */
...
@ApiModelProperty("备注信息")
    ...
    /**
     * 方法类型(1列表查询，2查询结果，3.保存操作类)
     */
@ApiModelProperty("方法类型(1列表查询，2查询结果，3.保存操作类)")
